...
export const MAT_SELECT_SCROLL_STRATEGY = new InjectionToken<
  () => ScrollStrategy
>('mat-select-clone-scroll-strategy');
    ...
    CanDisableRipple
{
  ...
  private _uid = `mat-select-clone-${nextUniqueId++}`;
  ...
  _valueId = `mat-select-clone-value-${nextUniqueId++}`;
  ...
  get shouldLabelFloat(): boolean {
    return (
      this._panelOpen || !this.empty || (this._focused && !!this._placeholder)
    );
  }
}
 ...
 */
@Directive({
  selector: 'mat-select-clone-trigger',
  providers: [{ provide: MAT_SELECT_TRIGGER, useExisting: MatSelectTrigger }],
})
export class MatSelectTrigger {}

@Component({
  selector: 'mat-select-clone',
  exportAs: 'matSelect',
